...
exports.getAllPayments = async (req, res) => {
  ...
  try {
    ...
    const { page, limit, searchText, center, date, month} = validatedQuery;
    console.log(center)

    // Call the DAO to get all collection officers
    const { items, total } = await ReportDAO.getAllPaymentsDAO(companyId, page, limit, searchText, center, date, month);
...
exports.getAllCollection = async (req, res) => {
  ...
  try {
    ...
    // Call the DAO to get all collection officers
    const { items, total } = await ReportDAO.getAllCollectionDAO(companyId, page, limit, searchText, center, date, month);
